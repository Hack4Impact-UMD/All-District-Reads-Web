...
function Login() {
  ...
  const [registrationButtonClicked, setRegistrationButtonClicked] = useState(false); // State to track if registration button is clicked
  ...
  return (
    <div>
      ...
      {registrationButtonClicked && <p>Registration successful!</p>} {/* Render message if registration is successful */}
    </div>
  );
}
